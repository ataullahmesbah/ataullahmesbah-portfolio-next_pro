...
const AllWebDevelopmentServices = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const res = await fetch(`/api/services/web-development?id=${id}`, {
                method: 'DELETE',
            });
                            ...
                            <tbody>
                                {filteredServices.length === 0 ? (
                                    ...
                                    filteredServices.map((svc) => (
                                        <tr key={svc._id} className="border-b border-gray-700">
                                            <td className="p-4">{svc.category}</td>
                                            <td className="p-4">{svc.services.map(s => s.name).join(', ')}</td>
                                            <td className="p-4 flex gap-2">
                                                ...
                                                <Link
                                                    href={`/admin-dashboard/services/web-devs/edit/${svc._id}`}
...
export default AllWebDevelopmentServices;