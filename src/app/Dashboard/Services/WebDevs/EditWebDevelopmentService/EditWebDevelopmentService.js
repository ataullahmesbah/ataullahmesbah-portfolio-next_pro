...
const EditWebDevelopmentService = ({ params }) => {
  const id = params?.id;
  ...
  useEffect(() => {
    ...
    const fetchService = async () => {
      try {
        const res = await fetch(`/api/services/web-development?id=${id}`, { cache: 'no-store' });
...
export default EditWebDevelopmentService;