...
const AllWebPackages = () => {
    ...
    const fetchPackages = async () => {
        try {
            const res = await fetch('/api/services/web-development/webpack', { cache: 'no-store' });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const res = await fetch(`/api/services/web-development/webpack?id=${id}`, {
                method: 'DELETE',
            });
                                    ...
                                    filteredPackages.map((pkg) => (
                                        <tr key={pkg._id} className="border-b border-gray-700">
                                            ...
                                            <td className="p-4 flex gap-2">
                                                ...
                                                <Link
                                                    href={`/admin-dashboard/services/web-devs/webpack/edit/${pkg._id}`}
