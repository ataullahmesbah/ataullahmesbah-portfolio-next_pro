                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                <div className="flex space-x-4 bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                                    {/* Twitter */}
                                    <a
                                        href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://yourwebsite.com/letter/${newsletter.slug}`)}&text=${encodeURIComponent(`Check out this newsletter: ${newsletter.title} by ${newsletter.author}`)}`}
                                        target="_blank"
                                    ...
                                    {/* Facebook */}
                                    <a
                                        href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://yourwebsite.com/letter/${newsletter.slug}`)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    {/* LinkedIn */}
                                    <a
                                        href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`https://yourwebsite.com/letter/${newsletter.slug}`)}&title=${encodeURIComponent(newsletter.title)}&summary=${encodeURIComponent(newsletter.metaDescription || newsletter.description)}&source=${encodeURIComponent(newsletter.author)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    {/* Medium */}
                                    <a
                                        href={`https://medium.com/?url=${encodeURIComponent(`https://yourwebsite.com/letter/${newsletter.slug}`)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
