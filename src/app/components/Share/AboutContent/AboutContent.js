...
import { FaGlobe, FaPenFancy, FaCode, FaRobot, FaSearch, FaPlane, FaGraduationCap } from "react-icons/fa";
        ...
        <div className="border-b border-b-gray-800">
                    ...
                    <div className="lg:col-span-2 bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 lg:p-10 border border-gray-700/50 shadow-lg hover:shadow-sky-500/10 transition-shadow duration-300">
                        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                {/* Education Badge */}
                                <div className="mt-4 flex items-center justify-center md:justify-start gap-2 text-gray-400 text-sm">
                                    <FaGraduationCap className="text-sky-400" />
                                    <span>BSc in Electrical Engineering - Southeast University</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="journey" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-24">
                ...
                <section className="relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="md:w-1/3">
                            <div className="p-4 bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-xl inline-flex items-center justify-center mb-4 border border-blue-500/20">
                            ...
                            <h2 className="text-2xl font-bold mb-2 text-white">AI Search Optimization</h2>
                            <p className="text-gray-400">GEO & SGE Focus</p>
                        </div>
                        <AnimatedCard delay={0.1}>
                            <h3 className="text-xl font-semibold mb-4 text-blue-300">Adapting to Generative Search</h3>
                            <div className="space-y-4 text-gray-300">
                                ...
                                <p>
                                    ...
                                    achieving <span className="text-blue-300 font-medium">40-60% higher engagement</span> in SGE environments.
                                </p>
                                <p>
                                    Implementing <span className="text-blue-300 font-medium">AI-ready content approaches</span> that perform across generative platforms
                ...
                <section className="relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="md:w-1/3">
                            <div className="p-4 bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-xl inline-flex items-center justify-center mb-4 border border-purple-500/20">
                                <div className="relative">
                            ...
                            <h2 className="text-2xl font-bold mb-2 text-white">Web Development</h2>
                            <p className="text-gray-400">Custom Website Solutions</p>
                        </div>
                        <AnimatedCard delay={0.2}>
                            <h3 className="text-xl font-semibold mb-4 text-purple-300">Building Custom Digital Experiences</h3>
                            <div className="space-y-4 text-gray-300">
                                <p>
                                    Creating <span className="text-purple-300 font-medium">custom websites tailored to specific needs</span> - from e-commerce stores and business platforms to personal portfolios and web applications.
                                </p>
                                <p>
                                    Expertise in modern technologies including <span className="text-purple-300 font-medium">React, Next.js, API development, and database integration</span>.
                                    Building <span className="text-purple-300 font-medium">fully responsive, SEO-friendly websites</span> with optimal performance and user experience.
                                </p>
                                <p>
                                    Specializing in <span className="text-purple-300 font-medium">product-level applications, e-commerce solutions, business websites, and personal portfolios</span>
                                    - with modern design principles and scalable architecture.
                                </p>
                            </div>
                        </AnimatedCard>
                    </div>
                ...
                {/* SEO Journey */}
                <section className="relative">
                    <div className="absolute -left-8 top-0 h-full w-1 bg-gradient-to-b from-green-400 to-blue-500 rounded-full hidden md:block"></div>

                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="md:w-1/3">
                            <div className="p-4 bg-gradient-to-br from-green-900/30 to-blue-900/30 rounded-xl inline-flex items-center justify-center mb-4 border border-green-500/20">
                                <FaSearch className="text-green-400 text-2xl" />
                            </div>
                            <h2 className="text-2xl font-bold mb-2 text-white">SEO Mastery</h2>
                            <p className="text-gray-400">Since 2020</p>
                        </div>
                        <AnimatedCard delay={0.1}>
                            <h3 className="text-xl font-semibold mb-4 text-green-300">Driving Organic Growth</h3>
                            <div className="space-y-4 text-gray-300">
                                <p>
                                ...
                                <p>
                                    Developed proprietary frameworks that deliver <span className="text-green-300 font-medium">300-500% organic traffic increases</span> within 6-12 months for clients across e-commerce, SaaS, and publishing.
                                </p>
                                <p>
                ...
                {/* Creative Journey */}
                <section className="relative">
                    <div className="absolute -left-8 top-0 h-full w-1 bg-gradient-to-b from-amber-400 to-pink-500 rounded-full hidden md:block"></div>

                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="md:w-1/3">
                            <div className="p-4 bg-gradient-to-br from-amber-900/30 to-pink-900/30 rounded-xl inline-flex items-center justify-center mb-4 border border-amber-500/20">
                                <FaPlane className="text-amber-400 text-2xl" />
                            </div>
                            <h2 className="text-2xl font-bold mb-2 text-white">Content & Travel</h2>
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                ...
                <Link
                    href="/contact"
                    className="group relative bg-gray-900/50 backdrop-blur-md border border-gray-700 text-white px-8 py-4 rounded-xl inline-flex items-center gap-3 transition-all duration-300 hover:bg-gray-800/70 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20 overflow-hidden"
