...
import { FiSearch, FiArrowLeft, FiFacebook, FiPlay, FiClock, FiExternalLink } from "react-icons/fi";
import Image from "next/image";
import { motion } from "framer-motion";

export default function FacebookContent({ videos = [] }) {
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold flex items-center gap-3">
                            <FiFacebook className="text-blue-500 text-4xl" /> 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        {currentVideos.map((video, index) => (
                            <motion.div
                                ...
                                className="group relative bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-blue-500/20 transition-all hover:-translate-y-1"
                            >
                                <div className="relative aspect-video bg-gradient-to-br from-blue-900/30 to-gray-800">
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <FiFacebook className="text-5xl text-gray-700" />
                                    </div>
                                    <div className="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent group-hover:from-blue-600/30 group-hover:to-transparent transition-all"></div>
