...
const LeftSideBanner = () => {
    ...
    return (
        <div className="flex flex-col items-center md:items-start md:w-1/2 gap-5 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start w-full">
                <button className="mt-6 w-36 bg-sky-800 text-white py-2 px-6 rounded-lg hover:bg-opacity-80 transition duration-300">
                    Get Started
                </button>
            </div>
        </div>
