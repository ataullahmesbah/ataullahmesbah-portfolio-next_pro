...
export default function PublicProfile({ profile, user }) {
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                {roleIcon}
                                <h2 className="text-2xl text-gray-300">{profile.title || 'Professional'}</h2>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 text-gray-300 mb-6">
                                ...
                                {user?.memberSince && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Member since {new Date(user.memberSince).toLocaleDateString('en-US', { year: 'numeric' })}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="flex gap-4">
                                {profile.socialLinks?.linkedin && (
                                    <a href={profile.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
                                        <FaLinkedin size={20} />
                                    </a>
                                )}
                                {profile.socialLinks?.twitter && (
                                    <a href={profile.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
                                        <FaTwitter size={20} />
                                    </a>
                                )}
