...
export default function PublicProfile({ username: propUsername }) {
    ...
    return (
        ...
        <>
            <Head>
                {/* Prevent ads from showing on this page */}
                <meta name="adsbygoogle" content="none" />
                <meta name="robots" content="noads" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "url": `https://ataullahmesbah.com/u/${username}`,
                        "sameAs": [
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row flex-wrap gap-8 items-start">
                            ...
                            <div className="flex-1">
                                ...
                                {/* In your PublicProfile component, update the verification badge section */}

                                {profile?.verification === 'accepted' && profile?.title && (
                                    <motion.div
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-medium text-green-400">
                                            {ExpertBadges[primaryRole] || ExpertBadges.default}
                                        </span>
                                    </motion.div>
                                )}
